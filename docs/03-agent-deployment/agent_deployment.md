...
Repeat all steps in section 3.1 for each additional endpoint. Each agent must be given a unique name, follow the approved tenant naming convention, and assigned to the correct tenant.
